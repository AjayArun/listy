...
templates['list-lists-template.handlebarse'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	<div class=\"list-list\" id=\""
    ...
    + "\" style=\"cursor: pointer;\">\n		<img class=\"delete-icon delete-list\" width=\"20\" height=\"20\" src=\"/img/delete-button.png\">\n		<h1>"
    + alias4(((helper = (helper = helpers.slug || (depth0 != null ? depth0.slug : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"slug","hash":{},"data":data}) : helper)))
    + "</h1>\n    </div>\n";
